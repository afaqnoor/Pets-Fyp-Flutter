...
import 'package:intoduction_screens/pages/Details/Fishes/FishesDetails/fishesdetails.dart';

class FishDetails extends StatefulWidget {
  const FishDetails({super.key});
...
class _FishDetailsState extends State<FishDetails> {
  final firestore = FirebaseFirestore.instance.collection('Fishes').snapshots();
  @override
