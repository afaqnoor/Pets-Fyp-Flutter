...
import 'package:intoduction_screens/pages/Details/Hamster/HamsterDetails/wishkerdetails.dart';
...
class _HamsterDetailsState extends State<HamsterDetails> {
  final firestore =
      FirebaseFirestore.instance.collection('Hamster').snapshots();
  @override
