...
import '../Details/Horses/HorsesDetails/horsesdetails.dart';

class HorseDetails extends StatefulWidget {
  const HorseDetails({super.key});

  @override
  State<HorseDetails> createState() => _HorseDetailsState();
}

class _HorseDetailsState extends State<HorseDetails> {
  final firestore = FirebaseFirestore.instance.collection('Horses').snapshots();
  @override
